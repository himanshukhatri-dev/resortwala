<#
.SYNOPSIS
    Direct Deployment script for Customer App.
#>
...
# --- DIRECT EXECUTION ---
Write-Host "Starting Direct Deployment for Customer App..." -ForegroundColor Magenta
if (Build-ReactApp "Customer" $Paths.Customer) {
