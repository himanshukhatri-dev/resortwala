...
class PaymentController extends Controller
{
    ...
    {
        $this->merchantId = env('PHONEPE_MERCHANT_ID', 'PGTESTPAYUAT'); // Sandbox Default
        $this->saltKey = env('PHONEPE_SALT_KEY', '099eb0cd-02cf-4e2a-8aca-3e6c6aff0399'); // Sandbox Default
