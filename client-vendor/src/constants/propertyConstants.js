...
export const AMENITY_TYPES = [
    ...
    { key: 'waterfall', label: 'Waterfall Fountain', type: 'bool' },
    { key: 'ice_bucket', label: 'Ice Bucket Setup', type: 'bool' },
    { key: 'parking', label: 'Free Parking', type: 'bool' },
    { key: 'selfie_point', label: 'Selfie Point', type: 'bool' },
    { key: 'garden', label: 'Green Garden & Lawns', type: 'bool' },
    { key: 'bonfire', label: 'Bonfire', type: 'bool' },
    { key: 'kitchen', label: 'Kitchen Access', type: 'bool' },
    { key: 'wifi', label: 'Free Wi-Fi', type: 'bool' },
    { key: 'power_backup', label: 'Power Backup', type: 'bool' },
    // New Amenities
    { key: 'laundry', label: 'Laundry Service', type: 'bool' },
    ...
    { key: 'steam_sauna', label: 'Steam & Sauna', type: 'bool' },
    { key: 'barbeque', label: 'Barbeque', type: 'bool' },
    { key: 'multilingual', label: 'Multilingual Staff', type: 'bool' },
    { key: 'game_room', label: 'Game Room', type: 'bool' }
];
