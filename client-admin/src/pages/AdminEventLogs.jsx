...
import { FaFilter, FaSync, FaChartLine, FaEye } from 'react-icons/fa';
                                ...
                                {loading ? (
                                    ...
                                    events.map((event) => (
                                        <tr key={event.id} className="hover:bg-gray-50">
                                            ...
                                            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500 font-mono truncate max-w-[100px]">
                                                {event.session_id?.substring(0, 12)}...
                                            </td>
                                            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                                {event.context?.device || 'Unknown'}
                                            </td>
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50" onClick={() => setSelectedEvent(null)}>
                    <div className="bg-white rounded-lg max-w-2xl w-full max-h-[80vh] overflow-auto" onClick={(e) => e.stopPropagation()}>
                        ...
                        <div className="p-6 space-y-4">
                            ...
                            <div>
                                <div className="text-sm font-medium text-gray-500">Event Data</div>
                                <pre className="mt-2 bg-gray-50 p-4 rounded-lg text-xs overflow-x-auto">
                                    {JSON.stringify(selectedEvent.event_data, null, 2)}
                                </pre>
                            </div>
                            <div>
                                <div className="text-sm font-medium text-gray-500">Context</div>
                                <pre className="mt-2 bg-gray-50 p-4 rounded-lg text-xs overflow-x-auto">
