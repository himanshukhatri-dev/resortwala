<#
.SYNOPSIS
    Admin UI Only Deployment Script.
#>
...
$Paths = @{
    "Admin" = @{
        "LocalSource" = "$PSScriptRoot/client-admin/dist"
        "DistDir"     = "." 
...
function Deploy-Component {
    ...
    $TarFileName = "deploy_package_admin_ui.tar.gz"
    $TarPath = ".\$TarFileName"
...
# --- DIRECT EXECUTION ---
Write-Host "Starting Admin UI Patch Deployment..." -ForegroundColor Magenta
